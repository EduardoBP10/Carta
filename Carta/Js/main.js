...
let para = "Liz"; // valor por defecto
let mensaje = `Te amo como he amado a
pocas personas en mi vida,
por eso estare aqui,
cuando la lluvia se haga tomenta
y no tengas a donde huir,
corre hacia mis brazos, estoy para ti❤️`;
...
let loadingText = "Para ti liz"; // valor por defecto para loading
